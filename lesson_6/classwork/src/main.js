...
// }
//age <= 22
// forEach не делает continue и break

listOfCompanys.forEach(function (elem, index, arr) {
    if (elem.age <= 22) {
...
// фильтр возвращает новый массив
...
var arr3 = listOfCompanys.filter(function (elem, index, arr) {
    // if(arr[index].age > 22){
    //     return true;
    // }
    // return false;
...
// у каждого друга имя больше 4 букв

var allNames = megaObject.friends.every(function (elem, index, arr) {
    // console.log(elem);
    return elem.name.split(' ')[0].length >= 4;
...
let megaArr = [10, 20, 30, 40];

let megaArr2 = megaArr.map(function (elem, index, arr) {
    return elem * 2;
});

// console.log(megaArr2);
// вернуть новый массив
//  у друзей будет новое свойство копани
// индекс у компани должен совпадать с ид мегаобжект

var superArr = listOfCompanys.map(function (elem, index, arr) {
    // получить друга у которого ид = индексу
    //создать необходимый объект
...
let newMapArray = [10, 20, 30, 40];

let newMapArray2 = newMapArray.map(function (elem, index, arr) {

    return  {
        "oldValue": newMapArray[index],
        "newValue": newMapArray[index]*2
    };

});
console.log(newMapArray2);
