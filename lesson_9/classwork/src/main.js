...
const user = {
  ...
  showFriendFruits(){
    //ver-1
    // var self = this;
    // this.friends.forEach(function (elem, index, array) {
    //   self.showFruits.call(elem);
    // });
    //ver-2
    // this.friends.forEach(function (elem, index, array) {
    ...
    // }.bind(this));
    //ver-3
    this.friends.forEach(elem => this.showFruits.call(elem));
  }
}

user.showFruits();
user.showFriendFruits();

// показать какие фрукты любит друг
// исп-те существующий метод showFruits
